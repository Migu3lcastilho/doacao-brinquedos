// Seleciona todos os botões que servem para ABRIR as respostas
var botoesAbrir = document.querySelectorAll(".btnMenu");

// Seleciona todos os botões que servem para FECHAR as respostas
...
// Percorre todos os botões de fechar
